...
const Spectacles = props => {
  const [masterTL1] = useState(new TimelineMax());
  // const [clearTL] = useState(new TimelineMax());
  const [showTL] = useState(new TimelineMax());
  const [blinkTL] = useState(new TimelineMax());
  const [glintTL] = useState(new TimelineMax());

  let $specsSVG = useRef(null);
  let $open = useRef(null);
  let $close = useRef(null);
  let $glintOne = useRef(null);
  let $glintTwo = useRef(null);
  let $glintThree = useRef(null);
  ...
  const blinkStage = () => {
    blinkTL
      // .to($open, 2, {})
      .to($open, 0.1, { ease: new SteppedEase.config(1), opacity: 0 })
      .to($close, 0.05, { ease: new SteppedEase.config(1), opacity: 1 })
      .to($close, 0.05, { ease: new SteppedEase.config(1), opacity: 0 })
      .to($open, 0.05, { ease: new SteppedEase.config(1), opacity: 1 })
      .to($open, 0.05, { ease: new SteppedEase.config(1), opacity: 0 })
      .to($close, 0.05, { ease: new SteppedEase.config(1), opacity: 1 })
      .to($close, 0.05, { ease: new SteppedEase.config(1), opacity: 0 })
      .to($open, 0.1, { ease: new SteppedEase.config(1), opacity: 1 });
  ...
  const glintStage = () => {
    glintTL
      .to($glintOne, 0.06, { ease: new SteppedEase.config(1), opacity: 0.25 })
      .to($glintOne, 0.06, { ease: new SteppedEase.config(1), opacity: 0 })
      .to($glintTwo, 0.06, { ease: new SteppedEase.config(1), opacity: 0.5 })
      .to($glintTwo, 0.06, { ease: new SteppedEase.config(1), opacity: 0 })
      .to($glintThree, 0.06, {
    ...
    <Transition
      ...
      <div className='specswrap'>
        <svg
          ...
          enableBackground='new 0 0 414.91 153.67'
          ref={elMain => {
            $specsSVG = elMain;
          }}>
          <g>
            <g>
              <path
                fill='#198bca'
                d='M407.71,14.09l-0.03-0.15c-5.25-0.93-81.27-8.73-130.84-7.87c-16.03,0.28-29.3,1.2-36.51,3.14
...
C409.26,25.47,409.11,24.03,407.71,14.09z'
            ...
            <g>
              <linearGradient
                ...
                <stop
                  offset='0'
                  style={{ stopColor: '#198BCA', stopOpacity: 0 }}
                />
                <stop offset='0.1' style={{ stopColor: '#1677A1' }} />
                <stop offset='0.25' style={{ stopColor: '#1B5F7E' }} />
                <stop offset='0.4877' style={{ stopColor: '#1677A1' }} />
                <stop offset='0.75' style={{ stopColor: '#1B5F7E' }} />
                <stop offset='0.9' style={{ stopColor: '#1677A1' }} />
                <stop
                  offset='1'
                  style={{ stopColor: '#198BCA', stopOpacity: 0 }}
                />
...
C409.26,25.47,409.11,24.03,407.71,14.09z'
            ...
            <g>
              <path
                fill='#A5B7BF'
                d='M173.83,85.83c-0.23,1.26-2.47,2.19-3.87,2.19s-4.99,0-6.16,0s-2.11,0.87-2.11,1.93
...
C176.76,37.3,176.04,73.49,173.83,85.83z'
            ...
            <g>
              <path
                fill='#A5B7BF'
                d='M241.08,85.83c0.23,1.26,2.47,2.19,3.87,2.19s4.99,0,6.16,0s2.11,0.87,2.11,1.93c0,1.07,0,15.97,0,17.63
...
c-0.42-21.52,0.42-33.09-4.42-38.18c-5.03-9.21-123.94-8.84-130.18-1.69C238.14,37.3,238.87,73.49,241.08,85.83z'
            ...
            <g
              ...
              <path
                fill='#2D2D2D'
                d='M132.59,62.18h-18.5v-18.5c0-0.39-0.31-0.7-0.7-0.7H92.67c-0.39,0-0.7,0.31-0.7,0.7V64.4
...
c0.39,0,0.7-0.31,0.7-0.7v-18.5h18.5c0.39,0,0.7-0.31,0.7-0.7V62.88C133.29,62.5,132.97,62.18,132.59,62.18z'
              ...
              <path
                fill='#2D2D2D'
                d='M282.32,62.18h18.5v-18.5c0-0.39,0.31-0.7,0.7-0.7h20.72c0.39,0,0.7,0.31,0.7,0.7V64.4
...
c-0.39,0-0.7-0.31-0.7-0.7v-18.5h-18.5c-0.39,0-0.7-0.31-0.7-0.7V62.88C281.61,62.5,281.93,62.18,282.32,62.18z'
            ...
            <g
              ...
              <path
                fill='#2D2D2D'
                d='M101.29,84.64h-8.5c-0.39,0-0.7-0.31-0.7-0.7V63.22c0-0.39,0.31-0.7,0.7-0.7h39.13
c0.39,0,0.7,0.31,0.7,0.7v20.72c0,0.39-0.31,0.7-0.7,0.7h-8.5H101.29z'
              />
              <path
                fill='#2D2D2D'
                d='M290.98,61.85h-8.64c-0.39,0-0.71,0.31-0.71,0.7v20.72c0,0.39,0.32,0.7,0.71,0.7h39.77
c0.39,0,0.71-0.31,0.71-0.7V62.55c0-0.39-0.32-0.7-0.71-0.7h-8.64H290.98z'
          ...
          <g
            ...
            <g>
              <path
                fill='#ffffff'
                d='M38.6,74.22c-0.01,0.49-0.67,34.84,4.86,34.84s6.1,0.48,7.27,0.48c1.17,0,2.11,0.87,2.11,1.94
c0,1.07,0.53,9.19,0.53,10.85c0,3.86,31.61,4.84,57.41,4L38.9,54.44C38.74,59.82,38.76,66.35,38.6,74.22z'
            ...
            <g>
              <path
                fill='#ffffff'
                d='M241.08,85.94c0.23,1.26,2.47,2.39,3.87,2.39s4.99,0,6.16,0s1.85,0.47,1.85,1.54c0,1.07,0,15.97,0,17.63
...
l-80.49-80.49C238.69,58.61,239.6,77.68,241.08,85.94z'
          ...
          <g
            ...
            <g>
              <path
                fill='#ffffff'
                d='M173.83,85.94c2.21-12.34,2.94-48.63-0.62-51.49c-3.19-3.65-35.85-5.39-67.67-5.12l58.86,59
c1.5,0,4.36,0,5.57,0C171.36,88.33,173.6,87.21,173.83,85.94z'
            ...
            <g>
              <path
                fill='#ffffff'
                d='M376.3,74.22c-0.42-21.52,0.42-33.09-4.42-38.18c-2.32-4.24-28.79-6.45-57.28-6.9l61.42,61.42
C376.46,82.35,376.31,74.45,376.3,74.22z'
          ...
          <g
            ...
            <g>
              <path
                fill='#ffffff'
                d='M43.02,36.04c-3.08,3.22-3.86,9.07-4.13,18.4l72.07,71.89c17.78-0.58,32.98-2.03,32.98-4
...
c0-1.07,0.69-1.54,1.85-1.54c0.16,0,0.36,0,0.59,0l-58.86-59.05C75.13,29.53,45.48,31.55,43.02,36.04z'
            ...
            <g>
              <path
                fill='#ffffff'
                d='M314.6,29.14c-33.38-0.53-69.53,1.35-72.9,5.21c-1.17,0.95-1.88,5.53-2.22,11.67l80.58,80.59
